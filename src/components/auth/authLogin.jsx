      ...
      <section className="relative py-10 h-screen bg-gray-900 sm:py-16 lg:py-24 font-mainFont text-white">
        <div className="absolute inset-0">
          <img
            ...
            src="https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDh8fHN0dWRlbnRzfGVufDB8fDB8fHww"
            alt=""
          />
        </div>
        ...
        {showErrorModal && <ErrorModal errorMessage={usernameError || passwordError || authStore.error} onClose={handleCloseErrorModal} />}
